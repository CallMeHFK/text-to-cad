...
package (`.claude-plugin/`, `.codex-plugin/`, and `.zcode-plugin/` hold the
manifests; the plugin's skills are `skills/` directly), so whatever is on `main`
is what agent installers copy.
